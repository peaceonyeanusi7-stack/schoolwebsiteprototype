...
function Page() {
  ...
  return (
    <DashboardShell roleLabel="Student" title="Hello, Scholar" subtitle="Your classes, assignments, results and payments — all in one place." accent="sunshine">
      ...
      <div className="grid gap-6 lg:grid-cols-3 mb-8">
        <div className="lg:col-span-2 rounded-3xl bg-card border border-border p-6">
          <div className="flex items-center gap-3 mb-4">
            <Receipt className="size-5 text-sunshine" />
            <h2 className="font-display text-2xl">School fees</h2>
          </div>
          {feesLoading ? (
                ...
                <div key={f.id} className="flex items-center justify-between gap-4 p-4 rounded-2xl border border-border">
                  ...
                  <div className="text-right">
                    ...
                    <button
                      ...
                      className="mt-1 inline-flex items-center gap-1 text-sm bg-sunshine text-royal rounded-full px-3 py-1 font-semibold disabled:opacity-60"
                    >
        ...
        <div className="rounded-3xl bg-card border border-border p-6">
          <div className="flex items-center gap-3 mb-4">
            <CreditCard className="size-5 text-sunshine" />
          ...
          <button
            ...
            className="mt-4 w-full bg-sunshine text-royal rounded-full px-4 py-2 text-sm font-semibold disabled:opacity-60"
          >
